...
function setupQRModal() {
  ...
  document.querySelectorAll('.qr-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      // No preview image, and this is not an omission.
      //
      // It used to be fetched from api.qrserver.com with the short URL inside
      // the query string, which handed a third party the one thing this product
      // promises to keep: where a link points and that it exists. In a tool
      // whose whole argument is that it does not talk to anyone, that was the
      // loudest exception in the codebase.
      //
      // The QR is generated by the operator's own QR-Forge instance, which the
      // button below already opens. Rendering it here would mean either that
      // third party again or a Go dependency; the second is a feature, not a fix.
